const template = (html, self) => function () {
  ...
  return html`
    ...
    <section class="section">
      <h1 class="h1">Payment Options</h1>
      <div class="grid">
        ...
        <span class="grid">
          ...
          Account No: 109453829582
          </p>
          <p>
          Bank: BDO<br>
          Account Name: Juvar Abrera<br>
          Account No: 001900318146
          </p>
        </span>
      ...
      <div class="banner-buttons">
        <a @click="${buy.bind(this)}" href="https://www.eventbrite.com/e/devfest-philippines-2018-tickets-49635185175" target="_blank" rel="noopener" class="button">
