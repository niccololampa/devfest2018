const template = (html) => html`
  ...
  <section class="section">
    <div class="section-container">
      <h1 class="about-header">About DevFest Philippines</h1>
      <p>
      ...
      <br><br>
      DevFest 2018 Philippines brings together experts in Android, Web and Cloud technologies to Manila for sessions, workshops and showcases. Our team is passionate in showcasing and enhancing the innate Filipino skill.
      </p>
    </div>
  </section>
